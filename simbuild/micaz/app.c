...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7b56458, const void *arg_0xb7b565f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7b078c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb79b1840), 
int (*key_eq_fn)(void *arg_0xb79b1c88, void *arg_0xb79b1e00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb78809b8, int arg_0xb7880b10);
static double RandomUniform(void );
...
# 29 "sendAckC.nc"
int sendAckC$random_p[1000];
#line 29
int sendAckC$random_c[1000];
...
#line 217
    {
      ...
      if (sendAckC$AMPacket$destination(buf) == AM_BROADCAST_ADDR && TOS_NODE_ID % 2 == 1) {
          ...
          if (strcmp(msg->key, sendAckC$key_p[sim_node()]) == 0) {
              ...
              sim_log_debug(163U, "role", "Message before pairing received from %-14hhu|\n", sendAckC$pairing_address[sim_node()]);
              ...
              if (sendAckC$AMSend$send(sendAckC$pairing_address[sim_node()], &sendAckC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
                  sim_log_debug(164U, "role", "pairing confirmation to node %hhu\n", sendAckC$pairing_address[sim_node()]);
                  sendAckC$locked[sim_node()] = TRUE;
                }
            }
          else {
              sim_log_debug(165U, "role", "keys do not match. msg received from %hhu\n", sendAckC$AMPacket$source(buf));
            }
        }

      if (sendAckC$AMPacket$destination(buf) == AM_BROADCAST_ADDR && TOS_NODE_ID % 2 == 0) {
          sim_log_debug(166U, "role", "!!!!!!!!!!!info key_c: %s\n", sendAckC$key_c[sim_node()]);
          if (strcmp(msg->key, sendAckC$key_c[sim_node()]) == 0) {

              sendAckC$pairing_address[sim_node()] = sendAckC$AMPacket$source(buf);
              sendAckC$paired[sim_node()] = TRUE;
              sim_log_debug(167U, "role", "Message before pairing received from %-14hhu|\n", sendAckC$pairing_address[sim_node()]);

              sendAckC$PacketAcknowledgements$requestAck(&sendAckC$packet[sim_node()]);
              if (sendAckC$AMSend$send(sendAckC$pairing_address[sim_node()], &sendAckC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {

                  sim_log_debug(168U, "role", "pairing confirmation to node %hhu\n", sendAckC$pairing_address[sim_node()]);
                  sendAckC$locked[sim_node()] = TRUE;
                }
            }
          else {
              sim_log_debug(169U, "role", "keys do not match. msg received from %hhu\n", sendAckC$AMPacket$source(buf));
            }
        }
      ...
      if (__nesc_ntoh_uint16(msg->msg_type.nxdata) == 3) {
          ...
          sim_log_debug(170U, "role", "update last child location!\n");
...
#line 162
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb73240a0, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb73240a0, addr, msg, len);
#line 80
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb7620178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb7620178, msg, payload, len);
#line 78
...
#line 123
{
  ...
  if (err == SUCCESS) {
      sim_log_debug(152U, "boot", "success\n");
      sendAckC$MilliTimer_pairing$startPeriodic(500);
    }
  else 
#line 128
    {
      sim_log_debug(153U, "boot", "else\n");
...
#line 134
{
  ...
  sim_log_debug(154U, "boot", "finish\n");
}
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb73256a8, message_t * msg, error_t error){
#line 100
  switch (arg_0xb73256a8) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb73256a8, msg, error);
#line 100
      break;
#line 100
    }
...
#line 289
{
  ...
  if (sendAckC$AMSend$send(sendAckC$pairing_address[sim_node()], &sendAckC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS && TOS_NODE_ID % 2 == 0) {
      sim_log_debug(172U, "radio_send", "radio_send: response message type: %d.\n", __nesc_ntoh_uint16(msg->msg_type.nxdata));
    }
}
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb77dc650){
#line 75
  switch (arg_0xb77dc650) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb77dc650);
#line 75
      break;
#line 75
    }
...
#line 161
      sim_log_debug(155U, "role", "mote: %u key %-20s\n", TOS_NODE_ID, msg->key);
      if (msg == (void *)0) {
          return;
        }
...
#line 172
{
  sim_log_debug(156U, "operation_phase", "Call sensor read\n");
...
#line 178
{
  sim_log_debug(157U, "alert", "ALERT! CHILD MISSING!:\n");
  sim_log_debug(158U, "alert", "location of the child, X = %hhu and Y = %hhu \n", sendAckC$last_child_loc[sim_node()].x, sendAckC$last_child_loc[sim_node()].y);
}
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb73833a8){
#line 83
  switch (arg_0xb73833a8) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb73833a8);
#line 83
      break;
#line 83
    }
...
#line 84
{
  ...
  sendAckC$random_p[sim_node()] = rand() % 2;
  sendAckC$random_c[sim_node()] = rand() % 2;

  if (TOS_NODE_ID % 2 == 1) {
      switch (sendAckC$random_p[sim_node()]) {
          case 0: 
      ...
      sim_log_debug(150U, "boot", "random_p %d key_p = %s\n", sendAckC$random_p[sim_node()], sendAckC$key_p[sim_node()]);
    }

  if (TOS_NODE_ID % 2 == 0) {
      switch (sendAckC$random_c[sim_node()]) {
          case 0: 
      ...
      sim_log_debug(151U, "boot", "random_c %d key_c = %s\n", sendAckC$random_c[sim_node()], sendAckC$key_c[sim_node()]);
    }
...
#line 185
{
  ...
  if (&sendAckC$packet[sim_node()] == buf && err == SUCCESS) {
      ...
      sim_log_debug(159U, "radio_ack", "SEND DONE!!!!!!!!!\n");
      ...
      if (&sendAckC$packet[sim_node()] == buf && sendAckC$PacketAcknowledgements$wasAcked(buf)) {
          ...
          if (!sendAckC$paired[sim_node()]) {
              ...
              sim_log_debug(160U, "radio_ack", "Still in pairing phase\n");
            }
        }
    }
}
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  /* Module sendAckC */
  if (!strcmp(varname, "sendAckC$random_p"))
  {
    *addr = (uintptr_t)&sendAckC$random_p[__nesc_mote];
    *size = sizeof(sendAckC$random_p[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "sendAckC$random_c"))
  {
    *addr = (uintptr_t)&sendAckC$random_c[__nesc_mote];
    *size = sizeof(sendAckC$random_c[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module sendAckC */
  memset((void *)&sendAckC$random_p[__nesc_mote], 0, sizeof sendAckC$random_p[__nesc_mote]);
  memset((void *)&sendAckC$random_c[__nesc_mote], 0, sizeof sendAckC$random_c[__nesc_mote]);
