...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7c18458, const void *arg_0xb7c185f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7bc98c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb7a73840), 
int (*key_eq_fn)(void *arg_0xb7a73c88, void *arg_0xb7a73e00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb79429b8, int arg_0xb7942b10);
static double RandomUniform(void );
...
#line 229
    {
      ...
      if (sendAckC$AMPacket$destination(buf) == AM_BROADCAST_ADDR) {
          ...
          if (strcmp(msg->key, sendAckC$key_p[sim_node()]) == 0) {
              ...
              sim_log_debug(160U, "role", "Message before pairing received from %-14hhu|\n", sendAckC$pairing_address[sim_node()]);
            }
          else {
              sim_log_debug(161U, "role", "keys do not match. msg received from %hhu\n", sendAckC$AMPacket$source(buf));
            }
        }
    }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb76e5ac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb76e5ac8) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb76e5ac8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb76e5108, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb76e5108, msg, error);
#line 110
}
#line 110
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb73f66a8, message_t * msg, error_t error){
#line 100
  switch (arg_0xb73f66a8) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb73f66a8, msg, error);
#line 100
      break;
#line 100
    }
...
#line 267
  ...
  if (TOS_NODE_ID == 2) {
    ...
    if (sendAckC$AMSend$send(1, &sendAckC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS && TOS_NODE_ID == 2) {
        sim_log_debug(162U, "radio_send", "radio_send: response message type: %d.\n", __nesc_ntoh_uint16(msg->msg_type.nxdata));
      }
    }
}
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb789e650){
#line 75
  switch (arg_0xb789e650) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb789e650);
#line 75
      break;
#line 75
    }
...
#line 162
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb73f50a0, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb73f50a0, addr, msg, len);
#line 80
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb74543a8){
#line 83
  switch (arg_0xb74543a8) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb74543a8);
#line 83
      break;
#line 83
    }
...
#line 184
{
  ...
  if (&sendAckC$packet[sim_node()] == buf && sendAckC$PacketAcknowledgements$wasAcked(buf)) {
      ...
      if (!sendAckC$paired[sim_node()]) {
          ...
          sim_log_debug(157U, "radio_ack", "Still in pairing phase\n");
        }
      else 
        {
