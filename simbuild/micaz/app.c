...
#line 168
    {
      ...
      sim_log_debug(165U, "radio_rec", "RADIO_REC: Received from mote %hhu, massage type: %d\n", smart_braceletsC$AMPacket$source(buf), __nesc_ntoh_uint8(msg->msg_type.nxdata));
...
#line 180
              ...
              if (smart_braceletsC$AMSend$send(smart_braceletsC$pairing_address[sim_node()], &smart_braceletsC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
                  sim_log_debug(166U, "radio_send", "RADIO_SEND: Sending pairing confirmation to mote %hhu\n", smart_braceletsC$pairing_address[sim_node()]);
...
#line 197
                ...
                if (smart_braceletsC$AMSend$send(smart_braceletsC$pairing_address[sim_node()], &smart_braceletsC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
                    sim_log_debug(167U, "radio_send", "RADIO_SEND: Sending pairing confirmation to mote %hhu\n", smart_braceletsC$pairing_address[sim_node()]);
                    smart_braceletsC$locked[sim_node()] = TRUE;
                  }
              }
          }
...
#line 207
          if (smart_braceletsC$AMPacket$destination(buf) == AM_BROADCAST_ADDR) {
              sim_log_debug(168U, "radio_rec", "RADIO_REC: Keys do not match. Message received from mote %hhu\n", smart_braceletsC$AMPacket$source(buf));
            }
          else {
...
#line 218
              ...
              if (smart_braceletsC$AMPacket$destination(buf) == TOS_NODE_ID && __nesc_ntoh_uint8(msg->msg_type.nxdata) == 3) {
                  ...
                  sim_log_debug(169U, "radio_rec", "RADIO_REC: Updating last child location!\n");
                  if (__nesc_ntoh_int8(msg->status.nxdata) == 14) {
                      sim_log_debug(170U, "alert", "************************************************\n");
                      sim_log_debug(171U, "alert", "**************** !!!!!ALERT!!!!! ***************\n");
                      sim_log_debug(172U, "alert", "************************************************\n");
                      sim_log_debug(173U, "alert", "************* !!!!!CHILD FELL!!!!! *************\n");
                      sim_log_debug(174U, "alert", "************************************************\n");
                      sim_log_debug(175U, "alert", "ALERT: Child fall location coordinates: [X = %hhu; Y = %hhu]\n", smart_braceletsC$last_child_loc[sim_node()].x, smart_braceletsC$last_child_loc[sim_node()].y);
                    }
                  smart_braceletsC$MilliTimer_alert$startOneShot(60000);
                }
              }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb7643ac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb7643ac8) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb7643ac8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
#line 162
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb733d0a0, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb733d0a0, addr, msg, len);
#line 80
...
#line 75
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb7643108, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb7643108, msg, error);
#line 110
}
#line 110
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb7641178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb7641178, msg, payload, len);
#line 78
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb733e6a8, message_t * msg, error_t error){
#line 100
  switch (arg_0xb733e6a8) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb733e6a8, msg, error);
#line 100
      break;
#line 100
    }
...
#line 244
{
  ...
  if (!smart_braceletsC$locked[sim_node()]) {
      ...
      if (smart_braceletsC$AMSend$send(smart_braceletsC$pairing_address[sim_node()], &smart_braceletsC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
          sim_log_debug(176U, "radio_send", "RADIO_SEND: Sending message type: %d, status: %d. Coordinates: [X = %d, Y = %d]\n", __nesc_ntoh_uint8(msg->msg_type.nxdata), __nesc_ntoh_int8(msg->status.nxdata), __nesc_ntoh_int8(msg->x.nxdata), __nesc_ntoh_int8(msg->y.nxdata));
          smart_braceletsC$locked[sim_node()] = TRUE;
        }
    }
}
...
#line 93
      ...
      if (smart_braceletsC$AMSend$send(AM_BROADCAST_ADDR, &smart_braceletsC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
          sim_log_debug(152U, "radio_send", "RADIO_SEND: Sending broadcast message with key: %s\n", msg->key);
          smart_braceletsC$locked[sim_node()] = TRUE;
        }
    }
}
...
#line 105
{
  sim_log_debug(153U, "role", "ROLE: Call sensor read\n");
...
#line 39
{
  sim_log_debug(148U, "boot", "BOOT: Application booted, generating key for mote %d...\n", TOS_NODE_ID);
...
#line 128
      ...
      if (smart_braceletsC$pairing_mode[sim_node()][TOS_NODE_ID] && smart_braceletsC$PacketAcknowledgements$wasAcked(buf)) {
          sim_log_debug(160U, "radio_ack", "RADIO_ACK: ACK received at time: %s\n", sim_time_string());
        }
      else {
        if (!smart_braceletsC$pairing_mode[sim_node()][TOS_NODE_ID] && !smart_braceletsC$operation_mode[sim_node()][TOS_NODE_ID] && smart_braceletsC$PacketAcknowledgements$wasAcked(buf)) {
            sim_log_debug(161U, "role", "ROLE: !!!!PAIRING PHASE COMPLETED!!!!\n");
