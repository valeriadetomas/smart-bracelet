...
bool smart_braceletsC$pairing_mode[1000][4];
...
#line 168
    {
      ...
      sim_log_debug(165U, "radio_rec", "radio_rec: received from mote %hhu type: %d \n", smart_braceletsC$AMPacket$source(buf), __nesc_ntoh_uint8(msg->msg_type.nxdata));


      if (smart_braceletsC$AMPacket$destination(buf) == AM_BROADCAST_ADDR && TOS_NODE_ID % 2 == 1 && strcmp(msg->key, smart_braceletsC$key_p[sim_node()]) == 0) {
...
#line 180
              ...
              smart_braceletsC$pairing_mode[sim_node()][TOS_NODE_ID] = FALSE;
              ...
              if (smart_braceletsC$AMSend$send(smart_braceletsC$pairing_address[sim_node()], &smart_braceletsC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
                  ...
                  sim_log_debug(167U, "radio_send", "radio_send: Pairing mode : [%d] Op mode : [%d]\n", smart_braceletsC$pairing_mode[sim_node()][TOS_NODE_ID], smart_braceletsC$operation_mode[sim_node()][TOS_NODE_ID]);
                  smart_braceletsC$locked[sim_node()] = TRUE;
                }
            }
        }
      else {
        if (smart_braceletsC$AMPacket$destination(buf) == AM_BROADCAST_ADDR && TOS_NODE_ID % 2 == 0 && strcmp(msg->key, smart_braceletsC$key_c[sim_node()]) == 0) {
...
#line 198
                ...
                if (smart_braceletsC$AMSend$send(smart_braceletsC$pairing_address[sim_node()], &smart_braceletsC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
                    sim_log_debug(168U, "radio_send", "radio_send: pairing confirmation to node %hhu\n", smart_braceletsC$pairing_address[sim_node()]);
                    sim_log_debug(169U, "radio_send", "radio_send: Pairing mode : [%d] Op mode : [%d]\n", smart_braceletsC$pairing_mode[sim_node()][TOS_NODE_ID], smart_braceletsC$operation_mode[sim_node()][TOS_NODE_ID]);
                    smart_braceletsC$locked[sim_node()] = TRUE;
                  }
              }
          }
...
#line 209
          if (smart_braceletsC$AMPacket$destination(buf) == AM_BROADCAST_ADDR) {
              sim_log_debug(170U, "role", "role: keys do not match. msg received from %hhu\n", smart_braceletsC$AMPacket$source(buf));
            }
          else {
            if (smart_braceletsC$AMPacket$destination(buf) == TOS_NODE_ID && __nesc_ntoh_uint8(msg->msg_type.nxdata) == 2) {
...
#line 220
              ...
              if (smart_braceletsC$AMPacket$destination(buf) == TOS_NODE_ID && __nesc_ntoh_uint8(msg->msg_type.nxdata) == 3) {

                  smart_braceletsC$last_child_loc[sim_node()].x = __nesc_ntoh_int8(msg->x.nxdata);
                  smart_braceletsC$last_child_loc[sim_node()].y = __nesc_ntoh_int8(msg->y.nxdata);
                  smart_braceletsC$last_child_loc[sim_node()].status = __nesc_ntoh_int8(msg->status.nxdata);
                  sim_log_debug(171U, "role", "info: update last child location!\n");
                  if (__nesc_ntoh_int8(msg->status.nxdata) == 14) {
                      sim_log_debug(172U, "role", "************************************************\n");
                      sim_log_debug(173U, "role", "**************** !!!!!ALERT!!!!! ***************\n");
                      sim_log_debug(174U, "role", "************************************************\n");
                      sim_log_debug(175U, "role", "************* !!!!!CHILD FELL!!!!! *************\n");
                      sim_log_debug(176U, "role", "************************************************\n");
                    }
                  smart_braceletsC$MilliTimer_alert$startOneShot(60000);
                }
              }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb76d7ac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb76d7ac8) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb76d7ac8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
#line 162
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb73cf0a0, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb73cf0a0, addr, msg, len);
#line 80
...
#line 75
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb76d7108, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb76d7108, msg, error);
#line 110
}
#line 110
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb76d5178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb76d5178, msg, payload, len);
#line 78
...
#line 63
{
  ...
  if (err == SUCCESS) {
      sim_log_debug(149U, "boot", "boot: success\n");
      smart_braceletsC$MilliTimer_pairing$startPeriodic(1000);
    }
  else 
#line 68
    {
      sim_log_debug(150U, "boot", "boot: failed\n");
...
#line 74
{
  sim_log_debug(151U, "boot", "finish\n");
}
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb73d06a8, message_t * msg, error_t error){
#line 100
  switch (arg_0xb73d06a8) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb73d06a8, msg, error);
#line 100
      break;
#line 100
    }
...
#line 245
{
  ...
  if (!smart_braceletsC$locked[sim_node()]) {
      ...
      if (smart_braceletsC$AMSend$send(smart_braceletsC$pairing_address[sim_node()], &smart_braceletsC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
          sim_log_debug(177U, "radio_send", "radio_send: response message type: %d.\n", __nesc_ntoh_uint8(msg->msg_type.nxdata));
          sim_log_debug(178U, "radio_send", "INFO MSG: Status %d. Coordinates: [X = %d, Y = %d].\n", __nesc_ntoh_int8(msg->status.nxdata), __nesc_ntoh_int8(msg->x.nxdata), __nesc_ntoh_int8(msg->y.nxdata));
          smart_braceletsC$locked[sim_node()] = TRUE;
        }
    }
}
...
#line 93
      ...
      if (smart_braceletsC$AMSend$send(AM_BROADCAST_ADDR, &smart_braceletsC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
          sim_log_debug(152U, "radio_send", "radio_send: pairing message with key: %s. \n", msg->key);
          smart_braceletsC$locked[sim_node()] = TRUE;
        }
    }
}
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb742e3a8){
#line 83
  switch (arg_0xb742e3a8) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb742e3a8);
#line 83
      break;
#line 83
    }
...
#line 39
{
  sim_log_debug(148U, "boot", "Application booted, generating key for node %d...\n", TOS_NODE_ID);
...
#line 128
      ...
      if (smart_braceletsC$pairing_mode[sim_node()][TOS_NODE_ID] && smart_braceletsC$PacketAcknowledgements$wasAcked(buf)) {
          sim_log_debug(160U, "radio_ack", "radio_ack: message broadcast was acked at time: %s \n", sim_time_string());
        }
      else {
        if (!smart_braceletsC$pairing_mode[sim_node()][TOS_NODE_ID] && !smart_braceletsC$operation_mode[sim_node()][TOS_NODE_ID] && smart_braceletsC$PacketAcknowledgements$wasAcked(buf)) {
            sim_log_debug(161U, "radio_ack", "radio_ack: pairing phase completed, Pairing mode : [%d] Op mode: [%d]\n", smart_braceletsC$pairing_mode[sim_node()][TOS_NODE_ID], smart_braceletsC$operation_mode[sim_node()][TOS_NODE_ID]);
...
#line 144
          ...
          if (smart_braceletsC$operation_mode[sim_node()][TOS_NODE_ID] && smart_braceletsC$PacketAcknowledgements$wasAcked(buf)) {
              sim_log_debug(162U, "radio_ack", "radio_ack: ACK received at time %s\n\n", sim_time_string());
            }
          else {
            if (smart_braceletsC$operation_mode[sim_node()][TOS_NODE_ID]) {
                sim_log_debug(163U, "radio_ack", "radio_ack: ACK NOT received\n");
              }
            else {
#line 156
              if (smart_braceletsC$pairing_mode[sim_node()][TOS_NODE_ID]) {
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  memcpy((void *)&smart_braceletsC$pairing_mode[__nesc_mote], (void *)&(unsigned char [4]){ TRUE }, sizeof smart_braceletsC$pairing_mode[__nesc_mote]);
